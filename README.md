...
1. задаём необходимую систему координат карты;
 ...
 4. перепроецирование слоёв;
  ...
  6. создание пакета листов карты;
...
## 8. Создание веб-карты полевых обследований на портале ArcGIS Enterprise
...
После добавления в карту всех необходимых слоё, обязательно нужно сохранить веб-карту. Для этого в верхней части нажать на кнопку *Сохранить* -> *Сохранить как*.
...
## 9. Настройка автономного режима в ArcGIS Enterprise
